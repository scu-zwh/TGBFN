...
ALL_COMMANDS = ['Line', 'Arc', 'Circle', 'EOS', 'SOL', 'Ext', 'Pad']
LINE_IDX = ALL_COMMANDS.index('Line') + 256
ARC_IDX = ALL_COMMANDS.index('Arc') + 256
CIRCLE_IDX = ALL_COMMANDS.index('Circle') + 256
EOS_IDX = ALL_COMMANDS.index('EOS') + 256
SOL_IDX = ALL_COMMANDS.index('SOL') + 256
EXT_IDX = ALL_COMMANDS.index('Ext') + 256
PAD_IDX = ALL_COMMANDS.index('Pad') + 256
